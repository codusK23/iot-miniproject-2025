...
namespace WpfMrpSimulatorApp.ViewModels
{
    public partial class MonitoringViewModel : ObservableObject
    {
        ...
        public MonitoringViewModel(IDialogCoordinator coordinator)
        {
            ...
            SchIdx = 1;  // 초기값 설정, 1부터 시작

            // MQTT 초기화
            brokerHost = "210.119.12.72";  // 본인 PC 아이피
            clientId = "MON01";
            mqttSubTopic = "pknu/sf72/data";
            mqttPubTopic = "pknu/sf72/control";
        ...
        public async Task SearchProcess()
        {
            ...
            try
            {
                ...
                {
                    await this.dialogCoordinator.ShowMessageAsync(this, "공정 조회", "해당하는 데이터가 없습니다.");
