...
- 용어
    - MES : Manufacturing Execution System 생산 실행 관리 시스템
        - 생산 현장에서 실시간으로 제조/생산 작업 계획, 실행, 추적, 모니터링하는 시스템
...
- [비전센서](https://www.devicemart.co.kr/goods/view?no=15548729) : AI 좁목 카메라 모듈
    - 긁힘, 오염, 결함, 조립 오류 탐지
...
2. NuGet 패키지 설치
    ...
    - Newtonsoft.json
3. View, ViewModel 구성
4. WPF 애니메이션 기능으로 컨테이어벨트구현

    https://github.com/user-attachments/assets/5ae3a0c6-fb89-476c-8408-ae0b6861cdb8
...
https://github.com/user-attachments/assets/954494b8-d8ad-4c38-9434-196ee1dd57d7
